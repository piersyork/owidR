...
**WARNING:** Due to a change in the Our World in Data Website, owidR will not currently work. Download the development version for a temporary fix (which may have some bugs). A full fix and CRAN update will follow in the coming days, there will be no syntax changes.
